    ...
    export default {
        ...
        methods: {
            ...
            */
            ...
            /* 2020/3/20
            * 作者：王青高
            * 功能：{Function} 跳转学习方案、联系客服、分享好友 三个模块
            * 参数：{Number} index: 0-学习方案, 1-联系客服, 2-分享好友
            */
            _Router(index) {
                console.log(index);
            },
