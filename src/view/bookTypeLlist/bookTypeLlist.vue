    ...
    <div class="bookTypeList pb100">
        <van-sticky>
            <div class="bookTypeList_sticky">
                ...
                />
                <ul class="bookTypeList_sticky_nav mtb10">
                ...
                <ul class="bookTypeList_title_dropDown" v-show="isShow">
                    <li class="bookTypeList_title_dropDown_item pl100">
